...
public class Complex {
  ...
  public String toString() {
    ...
    double rounded_re = Math.round(factor * re) / factor;
    double rounded_im = Math.round(factor * im) / factor;
    if ((-epsilon < im) && (im < epsilon)) return rounded_re + "";
    if ((-epsilon < re) && (re < epsilon)) return rounded_im + "i";
    if (im <  0) return "(" + rounded_re + " - " + (-rounded_im) + "i" + ")";
    return "(" + rounded_re + " + " + rounded_im + "i" + ")";
  }
