       ...
       if (op instanceof OneQubitOperation) {
          ...
          if (op1.gate.equals("H")) {
             ...
             if (wk.ket.get(op1.arg)) {
                wk.amplitude = new Complex(0.0,0.0).minus(
                                     wka.times(oneDivSqrt2));
             }
             else {
                wk.amplitude = wka.times(oneDivSqrt2);
             }
          ...
          if (op1.gate.equals("T")) {
             ...
             if (wk.ket.get(op1.arg)) {
                wk.amplitude = wk.amplitude.times(eipi4);
             }
          }
          else
          if (op1.gate.equals("D")) {
             ...
             if (wk.ket.get(op1.arg)) {
                wk.amplitude = wk.amplitude.times(eipi4dagger);
             }
          }
          else
          if (op1.gate.equals("S")) {
             ...
             if (wk.ket.get(op1.arg)) {
                wk.amplitude = wk.amplitude.times(i);
             }
          }
          else
          ...
          if (op1.gate.equals("Z")) {
             if (wk.ket.get(op1.arg)) {
                wk.amplitude = new Complex(0.0,0.0).minus(wk.amplitude);
             }
          }
       } 
       else 
